//
// Created by driverless on 29/05/21.
//
...
namespace mpcc {
    ...
    StateVector Model::getF(const State &x, const Input &u) const {
        ...
        f(2) = 1.0 / param_.m *
               (Fm * (1 + cos(delta)) - friction_force - tire_forces_front.F_y * std::sin(delta) + param_.m * vy * r);
        f(3) = 1.0 / param_.m *
               (Fm * sin(delta) + tire_forces_rear.F_y + tire_forces_front.F_y * std::cos(delta) - param_.m * vx * r);
        f(4) = 1.0 / param_.Iz * (Fm * sin(delta) * param_.lf + tire_forces_front.F_y * param_.lf * std::cos(delta) -
                                  tire_forces_rear.F_y * param_.lr + Mz);
        f(5) = dFm;
        f(6) = dDelta;
...
//    LinModelMatrix lin_model_c;
        ...
        const double df2_k =
                -vx * cos(mu) - (vy * sin(mu)) / (k * n - 1.0) + k * n * vy * sin(mu) * 1.0 / pow(k * n - 1.0, 2.0);


        // f3 = r;
        const double df3_dvx = (param_.Cr2 * vx * 2.0 - (param_.Bf * param_.Cf * param_.Df * cos(param_.Cf *
                                                                                                 atan(param_.Bf *
                                                                                                      (delta -
                                                                                                       atan2(vy +
                                                                                                             param_.lf *
                                                                                                             r, vx)))) *
                                                         sin(delta) * (vy + param_.lf * r)) /
                                                        (((param_.Bf * param_.Bf) *
                                                          pow(delta - atan2(vy + param_.lf * r, vx), 2.0) + 1.0) *
                                                         (pow(vy + param_.lf * r, 2.0) + vx * vx))) / param_.m;
        const double df3_dvy = (param_.m * r + (param_.Bf * param_.Cf * param_.Df * vx * cos(param_.Cf *
                                                                                             atan(param_.Bf * (delta -
                                                                                                               atan2(vy +
                                                                                                                     param_.lf *
                                                                                                                     r,
                                                                                                                     vx)))) *
                                                sin(delta)) / (((param_.Bf * param_.Bf) *
                                                                pow(delta - atan2(vy + param_.lf * r, vx), 2.0) + 1.0) *
                                                               (pow(vy + param_.lf * r, 2.0) + vx * vx))) / param_.m;
        const double df3_dr = (param_.m * vy + (param_.Bf * param_.Cf * param_.Df * param_.lf * vx * cos(param_.Cf *
                                                                                                         atan(param_.Bf *
                                                                                                              (delta -
                                                                                                               atan2(vy +
                                                                                                                     param_.lf *
        ...
        const double df3_ddelta = -(Fm * sin(delta) + param_.Df * cos(delta) * sin(param_.Cf * atan(param_.Bf * (delta -
                                                                                                                 atan2(vy +
                                                                                                                       param_.lf *
                                                                                                                       r,
                                                                                                                       vx)))) +
                                    (param_.Bf * param_.Cf * param_.Df *
                                     cos(param_.Cf * atan(param_.Bf * (delta - atan2(vy + param_.lf * r, vx)))) *
                                     sin(delta)) /
                                    ((param_.Bf * param_.Bf) * pow(delta - atan2(vy + param_.lf * r, vx), 2.0) + 1.0)) /
                                  param_.m;

        // f4 = 1/param_.m*(F_rx + F_fric - F_fy*std::sin(delta) + param_.m*v_y*r);
        const double df4_dvx = -(param_.m * r - (param_.Bf * param_.Cf * param_.Df * cos(delta) * cos(param_.Cf *
                                                                                                      atan(param_.Bf *
                                                                                                           (delta -
                                                                                                            atan2(vy +
                                                                                                                  param_.lf *
                                                                                                                  r,
                                                                                                                  vx)))) *
                                                 (vy + param_.lf * r)) / (((param_.Bf * param_.Bf) *
                                                                           pow(delta - atan2(vy + param_.lf * r, vx),
                                                                               2.0) + 1.0) *
                                                                          (pow(vy + param_.lf * r, 2.0) + vx * vx))) /
                               param_.m;
        const double df4_dvy = -(param_.Bf * param_.Cf * param_.Df * vx * cos(delta) *
                                 cos(param_.Cf * atan(param_.Bf * (delta - atan2(vy + param_.lf * r, vx))))) /
                               (param_.m *
                                ((param_.Bf * param_.Bf) * pow(delta - atan2(vy + param_.lf * r, vx), 2.0) + 1.0) *
                                (pow(vy + param_.lf * r, 2.0) + vx * vx));
        const double df4_dr = -(param_.m * vx + (param_.Bf * param_.Cf * param_.Df * param_.lf * vx * cos(delta) *
                                                 cos(param_.Cf *
                                                     atan(param_.Bf * (delta - atan2(vy + param_.lf * r, vx))))) /
                                                (((param_.Bf * param_.Bf) *
                                                  pow(delta - atan2(vy + param_.lf * r, vx), 2.0) + 1.0) *
                                                 (pow(vy + param_.lf * r, 2.0) + vx * vx))) / param_.m;
        const double df4_dFm = sin(delta) / param_.m;
        const double df4_ddelta = (Fm * cos(delta) - param_.Df * sin(delta) * sin(param_.Cf * atan(param_.Bf * (delta -
                                                                                                                atan2(vy +
                                                                                                                      param_.lf *
                                                                                                                      r,
                                                                                                                      vx)))) +
                                   (param_.Bf * param_.Cf * param_.Df * cos(delta) *
                                    cos(param_.Cf * atan(param_.Bf * (delta - atan2(vy + param_.lf * r, vx))))) /
                                   ((param_.Bf * param_.Bf) * pow(delta - atan2(vy + param_.lf * r, vx), 2.0) + 1.0)) /
                                  param_.m;

        // f5 = 1/param_.m*(F_ry + F_fy*std::cos(delta) - param_.m*v_x*r);
        const double df5_dvx = (param_.Bf * param_.Cf * param_.Df * param_.lf * cos(delta) *
                                cos(param_.Cf * atan(param_.Bf * (delta - atan2(vy + param_.lf * r, vx)))) *
                                (vy + param_.lf * r)) / (param_.Iz * ((param_.Bf * param_.Bf) *
                                                                      pow(delta - atan2(vy + param_.lf * r, vx), 2.0) +
                                                                      1.0) * (pow(vy + param_.lf * r, 2.0) + vx * vx));
        const double df5_dvy = -(param_.Bf * param_.Cf * param_.Df * param_.lf * vx * cos(delta) *
                                 cos(param_.Cf * atan(param_.Bf * (delta - atan2(vy + param_.lf * r, vx))))) /
                               (param_.Iz *
                                ((param_.Bf * param_.Bf) * pow(delta - atan2(vy + param_.lf * r, vx), 2.0) + 1.0) *
                                (pow(vy + param_.lf * r, 2.0) + vx * vx));
        const double df5_dr = -(param_.Bf * param_.Cf * param_.Df * (param_.lf * param_.lf) * vx * cos(delta) *
                                cos(param_.Cf * atan(param_.Bf * (delta - atan2(vy + param_.lf * r, vx))))) /
                              (param_.Iz *
                               ((param_.Bf * param_.Bf) * pow(delta - atan2(vy + param_.lf * r, vx), 2.0) + 1.0) *
                               (pow(vy + param_.lf * r, 2.0) + vx * vx));
        const double df5_dFm = (param_.lf * sin(delta)) / param_.Iz;
        const double df5_ddelta = (Fm * param_.lf * cos(delta) - param_.Df * param_.lf * sin(delta) * sin(param_.Cf *
                                                                                                          atan(param_.Bf *
                                                                                                               (delta -
                                                                                                                atan2(vy +
                                                                                                                      param_.lf *
                                                                                                                      r,
                                                                                                                      vx)))) +
                                   (param_.Bf * param_.Cf * param_.Df * param_.lf * cos(delta) *
                                    cos(param_.Cf * atan(param_.Bf * (delta - atan2(vy + param_.lf * r, vx))))) /
                                   ((param_.Bf * param_.Bf) * pow(delta - atan2(vy + param_.lf * r, vx), 2.0) + 1.0)) /
                                  param_.Iz;
...
// Mixed RK4 - EXPM method
    LinModelMatrix Model::discretizeModel(const LinModelMatrix &lin_model_c, const State &x, const Input &u,
